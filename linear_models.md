...
Let’s fit the model that we care about
...
Residuals are evenly distributed around 0 and then the borough have
different residual ranges (Manhattan and BK are very high.)

Ylim zooms in

Shows skewness in distribution of residuals
...
Not seeing any significance but can just sort of see what is going on…
